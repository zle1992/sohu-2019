...
class CRF_KERAS(object):
    ...
    def get_model(self):
      # main
        ...
        x = Bidirectional(LSTM(self.parms['n_lstm'], return_sequences=True))(x)
    ...
    def train(self,):
        ...
        x_train,x_dev,y_train,y_dev=train_test_split(self.X_train,self.Y_train ,test_size=0.1, random_state=42)
...
class BaseTrain(object):
    ...
    def predict_Emotion(self,df_test):
        ...
        df_test['emotion_pred'] = ','.join(['POS','POS','POS'])
